...
var _chunkGA7DXWKMjs = require('./chunk-GA7DXWKM.js');
...
async function load(filepath, themeMeta, content) {
  ...
  const data = await _chunkGA7DXWKMjs.parse.call(void 0, markdown, filepath, themeMeta, [], async (headmatter, exts, filepath2) => {
  ...
  for (let iSlide = 0; iSlide < data.slides.length; ) {
    ...
    const subSlides = await _chunkGA7DXWKMjs.parse.call(void 0, raw, path, themeMeta, preparserExtensions);
    for (const [offset, subSlide] of subSlides.slides.entries()) {
      ...
      data.features = _chunkGA7DXWKMjs.mergeFeatureFlags.call(void 0, data.features, _chunkGA7DXWKMjs.detectFeatures.call(void 0, raw));
      entries.add(path);
...
async function save(data, filepath) {
  ...
  await _fs.promises.writeFile(filepath, _chunkGA7DXWKMjs.stringify.call(void 0, data), "utf-8");
}
async function saveExternalSlide(slide) {
  await _fs.promises.writeFile(slide.filepath, _chunkGA7DXWKMjs.stringifySlide.call(void 0, slide), "utf-8");
}
...
exports.detectFeatures = _chunkGA7DXWKMjs.detectFeatures; exports.filterDisabled = _chunkGA7DXWKMjs.filterDisabled; exports.getDefaultConfig = _chunkGA7DXWKMjs.getDefaultConfig; exports.injectPreparserExtensionLoader = injectPreparserExtensionLoader; exports.load = load; exports.mergeFeatureFlags = _chunkGA7DXWKMjs.mergeFeatureFlags; exports.parse = _chunkGA7DXWKMjs.parse; exports.parseAspectRatio = _chunkGA7DXWKMjs.parseAspectRatio; exports.parseRangeString = _chunkGA7DXWKMjs.parseRangeString; exports.parseSlide = _chunkGA7DXWKMjs.parseSlide; exports.prettify = _chunkGA7DXWKMjs.prettify; exports.prettifySlide = _chunkGA7DXWKMjs.prettifySlide; exports.resolveConfig = _chunkGA7DXWKMjs.resolveConfig; exports.resolveFonts = _chunkGA7DXWKMjs.resolveFonts; exports.save = save; exports.saveExternalSlide = saveExternalSlide; exports.scanMonacoModules = _chunkGA7DXWKMjs.scanMonacoModules; exports.stringify = _chunkGA7DXWKMjs.stringify; exports.stringifySlide = _chunkGA7DXWKMjs.stringifySlide; exports.verifyConfig = _chunkGA7DXWKMjs.verifyConfig;
