...
async function parse(markdown, filepath, themeMeta, extensions, onHeadmatter) {
  ...
  }
  {
    ...
    if (onHeadmatter) {
      const o = _nullishCoalesce(_jsyaml2.default.load(hm), () => ( {}));
      extensions = await onHeadmatter(o, _nullishCoalesce(extensions, () => ( [])), filepath);
    }
  }
  if (extensions) {
    for (const e of extensions) {
