import {
  typescriptDefaults
} from "./chunk-VQUEU2DD.js";
import {
  editor_api_exports
} from "./chunk-4ENQCUFM.js";
import {
  __publicField
  ...
  async provideDocumentSymbols(model, token) {
    ...
    const convert = (item, containerLabel) => {
      ...
      const result2 = {
        ...
        tags: [],
        children: (_a = item.childItems) == null ? void 0 : _a.map((child) => convert(child, result2.name)),
...
monaco-editor/esm/vs/language/typescript/tsMode.js:
   ...
   *-----------------------------------------------------------------------------*)
*/
//# sourceMappingURL=tsMode-7JVOV2J4.js.map
