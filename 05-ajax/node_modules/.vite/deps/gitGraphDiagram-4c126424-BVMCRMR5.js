...
// node_modules/mermaid/dist/gitGraphDiagram-4c126424.js
var pe = function() {
  var r = function(q, m, b, k) {
    for (b = b || {}, k = q.length; k--; b[q[k]] = m)
      ;
    return b;
  }, a = [1, 4], o = [1, 7], p = [1, 5], n = [1, 9], c = [1, 6], u = [2, 6], h = [1, 16], w2 = [6, 8, 14, 20, 22, 24, 25, 27, 29, 32, 37, 40, 50, 55], x = [8, 14, 20, 22, 24, 25, 27, 29, 32, 37, 40], l = [8, 13, 14, 20, 22, 24, 25, 27, 29, 32, 37, 40], g = [1, 26], f = [6, 8, 14, 50, 55], s = [8, 14, 55], _ = [1, 53], T = [1, 52], O = [8, 14, 30, 33, 35, 38, 55], E = [1, 67], d = [1, 68], y = [1, 69], H = [8, 14, 33, 35, 42, 55], ce = {
    trace: function() {
    },
    yy: {},
    ...
    parse: function(m) {
      var b = this, k = [0], i = [], v = [null], e = [], W = this.table, t = "", re = 0, ge2 = 0, Me = 2, de = 1, Ce = e.slice.call(arguments, 1), M = Object.create(this.lexer), Y = { yy: {} };
...
Expecting ` + se.join(", ") + ", got '" + (this.terminals_[P] || P) + "'" : ue = "Parse error on line " + (re + 1) + ": Unexpected " + (P == de ? "end of input" : "'" + (this.terminals_[P] || P) + "'"), this.parseError(ue, {
        ...
        switch (B[0]) {
          case 1:
            k.push(P), v.push(M.yytext), e.push(M.yylloc), k.push(B[1]), P = null, ge2 = M.yyleng, t = M.yytext, re = M.yylineno, he = M.yylloc;
            break;
          case 2:
    ...
    var q = {
      ...
      setInput: function(m, b) {
        return this.yy = b || this.yy || {}, this._input = m, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = {
          first_line: 1,
          first_column: 0,
          last_line: 1,
          last_column: 0
...
` + b + "^";
      ...
      next: function() {
        ...
        for (var v = this._currentRules(), e = 0; e < v.length; e++)
          if (k = this._input.match(this.rules[v[e]]), k && (!b || k[0].length > b[0].length)) {
            if (b = k, i = e, this.options.backtrack_lexer) {
              if (m = this.test_match(k, v[e]), m !== false)
                return m;
              if (this._backtrack) {
                b = false;
                continue;
        ...
        return b ? (m = this.test_match(b, v[i]), m !== false ? m : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
...
pe.parser = pe;
var Ye = pe;
var ae = Ft().gitGraph.mainBranchName;
var Ke = Ft().gitGraph.mainBranchOrder;
var R = {};
var G = null;
var Z = {};
...
var Fe = function(r, a, o) {
  ge.parseDirective(this, r, a, o);
};
function Ue(r, a) {
  const o = /* @__PURE__ */ Object.create(null);
  return r.reduce((p, n) => {
    const c = a(n);
    return o[c] || (o[c] = true, p.push(n)), p;
  }, []);
}
var Je = function(r) {
  ye = r;
...
var Ee = {};
var We = function(r) {
  w.debug("options str", r), r = r && r.trim(), r = r || "{}";
  try {
    Ee = JSON.parse(r);
  } catch (a) {
    w.error("error while parsing gitGraph options", a.message);
  }
};
var Xe = function() {
  return Ee;
};
var Qe = function(r, a, o, p) {
  w.debug("Entering commit:", r, a, o, p), a = Rn.sanitizeText(a, Ft()), r = Rn.sanitizeText(r, Ft()), p = Rn.sanitizeText(p, Ft());
  const n = {
    id: a || U + "-" + be(),
    message: r,
    seq: U++,
  ...
  G = n, R[n.id] = n, L[A] = n.id, w.debug("in pushCommit " + n.id);
};
var Ze = function(r, a) {
  if (r = Rn.sanitizeText(r, Ft()), L[r] === void 0)
    L[r] = G != null ? G.id : null, Z[r] = { name: r, order: a ? parseInt(a, 10) : null }, we(r), w.debug("in createBranch");
  else {
    let o = new Error(
...
var $e = function(r, a, o, p) {
  r = Rn.sanitizeText(r, Ft()), a = Rn.sanitizeText(a, Ft());
  ...
  G = u, R[u.id] = u, L[A] = u.id, w.debug(L), w.debug("in mergeBranch");
};
var et = function(r, a, o) {
  if (w.debug("Entering cherryPick:", r, a, o), r = Rn.sanitizeText(r, Ft()), a = Rn.sanitizeText(a, Ft()), o = Rn.sanitizeText(o, Ft()), !r || R[r] === void 0) {
    let c = new Error(
  ...
  if (!a || R[a] === void 0) {
    ...
    G = u, R[u.id] = u, L[A] = u.id, w.debug(L), w.debug("in cherryPick");
  }
};
var we = function(r) {
  if (r = Rn.sanitizeText(r, Ft()), L[r] === void 0) {
...
function Te(r) {
  ...
  for (let n in L)
    L[n] === a.id && p.push(n);
  if (w.debug(p.join(" ")), a.parents && a.parents.length == 2) {
...
var rt = function() {
  R = {}, G = null;
  let r = Ft().gitGraph.mainBranchName, a = Ft().gitGraph.mainBranchOrder;
  L = {}, L[r] = null, Z = {}, Z[r] = { name: r, order: a }, A = r, U = 0, Fl();
};
var it = function() {
...
var _e = (r, a, o) => {
  const p = Dl().gitGraph, n = r.append("g").attr("class", "commit-bullets"), c = r.append("g").attr("class", "commit-labels");
  let u = 0;
...
var mt = (r, a, o) => Object.keys(o).filter((c) => o[c].branch === a.branch && o[c].seq > r.seq && o[c].seq < a.seq).length > 0;
var Q = (r, a, o = 0) => {
...
var ut = (r, a, o, p) => {
  ...
  let h = "", w2 = "", x = 0, l = 0, g = C[o.branch].index, f;
  if (u) {
    h = "A 10 10, 0, 0, 0,", w2 = "A 10 10, 0, 0, 1,", x = 10, l = 10, g = C[o.branch].index;
    const s = n.y < c.y ? Q(n.y, c.y) : Q(c.y, n.y), _ = n.x < c.x ? Q(n.x, c.x) : Q(c.x, n.x);
    S === "TB" ? n.x < c.x ? f = `M ${n.x} ${n.y} L ${_ - x} ${n.y} ${w2} ${_} ${n.y + l} L ${_} ${c.y - x} ${h} ${_ + l} ${c.y} L ${c.x} ${c.y}` : f = `M ${n.x} ${n.y} L ${_ + x} ${n.y} ${h} ${_} ${n.y + l} L ${_} ${c.y - x} ${w2} ${_ - l} ${c.y} L ${c.x} ${c.y}` : n.y < c.y ? f = `M ${n.x} ${n.y} L ${n.x} ${s - x} ${h} ${n.x + l} ${s} L ${c.x - x} ${s} ${w2} ${c.x} ${s + l} L ${c.x} ${c.y}` : f = `M ${n.x} ${n.y} L ${n.x} ${s + x} ${w2} ${n.x + l} ${s} L ${c.x - x} ${s} ${h} ${c.x} ${s - l} L ${c.x} ${c.y}`;
  } else
    S === "TB" ? (n.x < c.x && (h = "A 20 20, 0, 0, 0,", w2 = "A 20 20, 0, 0, 1,", x = 20, l = 20, g = C[o.branch].index, f = `M ${n.x} ${n.y} L ${c.x - x} ${n.y} ${w2} ${c.x} ${n.y + l} L ${c.x} ${c.y}`), n.x > c.x && (h = "A 20 20, 0, 0, 0,", w2 = "A 20 20, 0, 0, 1,", x = 20, l = 20, g = C[a.branch].index, f = `M ${n.x} ${n.y} L ${n.x} ${c.y - x} ${w2} ${n.x - l} ${c.y} L ${c.x} ${c.y}`), n.x === c.x && (g = C[a.branch].index, f = `M ${n.x} ${n.y} L ${n.x + x} ${n.y} ${h} ${n.x + l} ${c.y + x} L ${c.x} ${c.y}`)) : (n.y < c.y && (h = "A 20 20, 0, 0, 0,", x = 20, l = 20, g = C[o.branch].index, f = `M ${n.x} ${n.y} L ${n.x} ${c.y - x} ${h} ${n.x + l} ${c.y} L ${c.x} ${c.y}`), n.y > c.y && (h = "A 20 20, 0, 0, 0,", x = 20, l = 20, g = C[a.branch].index, f = `M ${n.x} ${n.y} L ${c.x - x} ${n.y} ${h} ${c.x} ${n.y - l} L ${c.x} ${c.y}`), n.y === c.y && (g = C[a.branch].index, f = `M ${n.x} ${n.y} L ${n.x} ${c.y - x} ${h} ${n.x + l} ${c.y} L ${c.x} ${c.y}`));
...
var ft = (r, a) => {
  const o = Dl().gitGraph, p = r.append("g");
  a.forEach((n, c) => {
    const u = c % F, h = C[n.name].pos, w2 = p.append("line");
    w2.attr("x1", 0), w2.attr("y1", h), w2.attr("x2", te), w2.attr("y2", h), w2.attr("class", "branch branch" + u), S === "TB" && (w2.attr("y1", 30), w2.attr("x1", h), w2.attr("y2", te), w2.attr("x2", h)), ne.push(h);
    let x = n.name;
    ...
    let _ = l.getBBox();
    g.attr("class", "branchLabelBkg label" + u).attr("rx", 4).attr("ry", 4).attr("x", -_.width - 4 - (o.rotateCommitLabel === true ? 30 : 0)).attr("y", -_.height / 2 + 8).attr("width", _.width + 18).attr("height", _.height + 4), s.attr(
      "transform",
      "translate(" + (-_.width - 14 - (o.rotateCommitLabel === true ? 30 : 0)) + ", " + (h - _.height / 2 - 1) + ")"
...
var bt = function(r, a, o, p) {
  ht();
  const n = Dl(), c = n.gitGraph;
  w.debug("in gitgraph renderer", r + `
`, "id:", a, o), X = p.db.getCommits();
  ...
  u.forEach((x, l) => {
    ...
    let T = g.getBBox();
    C[x.name] = { pos: w2, index: l }, w2 += 50 + (c.rotateCommitLabel ? 40 : 0) + (S === "TB" ? T.width / 2 : 0), _.remove(), s.remove(), f.remove();
  }), _e(h, X, false), c.showBranches && ft(h, u), pt(h, X), _e(h, X, true), Di.insertTitle(
    h,
    "gitTitleText",
    c.titleTopMargin,
...
//# sourceMappingURL=gitGraphDiagram-4c126424-BVMCRMR5.js.map
