...
// node_modules/mermaid/dist/quadrantDiagram-6f203608.js
var qt = function() {
  var e = function(K, n, r, d) {
    ...
    parse: function(n) {
      ...
      for (var W, $, Q, gt, tt = {}, st, O, At, ot; ; ) {
        if ($ = d[d.length - 1], this.defaultActions[$] ? Q = this.defaultActions[$] : ((W === null || typeof W > "u") && (W = Ct2()), Q = it[$] && it[$][W]), typeof Q > "u" || !Q.length || !Q[0]) {
          var pt = "";
          ot = [];
          for (st in it[$])
...
var Qt = class {
  ...
  getDefaultConfig() {
    ...
    return {
      ...
      showYAxis: true,
      showTitle: true,
      chartHeight: ((a = xp.quadrantChart) == null ? void 0 : a.chartWidth) || 500,
      chartWidth: ((h = xp.quadrantChart) == null ? void 0 : h.chartHeight) || 500,
      titlePadding: ((f = xp.quadrantChart) == null ? void 0 : f.titlePadding) || 10,
      titleFontSize: ((g = xp.quadrantChart) == null ? void 0 : g.titleFontSize) || 20,
      quadrantPadding: ((u = xp.quadrantChart) == null ? void 0 : u.quadrantPadding) || 5,
      xAxisLabelPadding: ((c = xp.quadrantChart) == null ? void 0 : c.xAxisLabelPadding) || 5,
      yAxisLabelPadding: ((p = xp.quadrantChart) == null ? void 0 : p.yAxisLabelPadding) || 5,
      xAxisLabelFontSize: ((s = xp.quadrantChart) == null ? void 0 : s.xAxisLabelFontSize) || 16,
      yAxisLabelFontSize: ((o = xp.quadrantChart) == null ? void 0 : o.yAxisLabelFontSize) || 16,
      quadrantLabelFontSize: ((m = xp.quadrantChart) == null ? void 0 : m.quadrantLabelFontSize) || 16,
      quadrantTextTopPadding: ((B = xp.quadrantChart) == null ? void 0 : B.quadrantTextTopPadding) || 5,
      pointTextPadding: ((V = xp.quadrantChart) == null ? void 0 : V.pointTextPadding) || 5,
      pointLabelFontSize: ((_ = xp.quadrantChart) == null ? void 0 : _.pointLabelFontSize) || 12,
      pointRadius: ((D = xp.quadrantChart) == null ? void 0 : D.pointRadius) || 5,
      xAxisPosition: ((b = xp.quadrantChart) == null ? void 0 : b.xAxisPosition) || "top",
      yAxisPosition: ((H = xp.quadrantChart) == null ? void 0 : H.yAxisPosition) || "left",
      quadrantInternalBorderStrokeWidth: ((G = xp.quadrantChart) == null ? void 0 : G.quadrantInternalBorderStrokeWidth) || 1,
      quadrantExternalBorderStrokeWidth: ((Z = xp.quadrantChart) == null ? void 0 : Z.quadrantExternalBorderStrokeWidth) || 2
    };
  }
  ...
  clear() {
    this.config = this.getDefaultConfig(), this.themeConfig = this.getDefaultThemeConfig(), this.data = this.getDefaultData(), w.info("clear called");
  }
  setData(a) {
  ...
  setConfig(a) {
    w.trace("setConfig called with: ", a), this.config = { ...this.config, ...a };
  }
  setThemeConfig(a) {
    w.trace("setThemeConfig called with: ", a), this.themeConfig = { ...this.themeConfig, ...a };
  }
  ...
  getQuadrantPoints(a) {
    const { quadrantSpace: h } = a, { quadrantHeight: f, quadrantLeft: g, quadrantTop: u, quadrantWidth: c } = h, p = Zn().domain([0, 1]).range([g, c + g]), s = Zn().domain([0, 1]).range([f + u, u]);
...
var w2 = new Qt();
function Mt(e) {
  w2.setData({ quadrant1Text: j(e.text) });
}
function Xt(e) {
  w2.setData({ quadrant2Text: j(e.text) });
}
function Ot(e) {
  w2.setData({ quadrant3Text: j(e.text) });
}
function Yt(e) {
  w2.setData({ quadrant4Text: j(e.text) });
}
function jt(e) {
  w2.setData({ xAxisLeftText: j(e.text) });
}
function Gt(e) {
  w2.setData({ xAxisRightText: j(e.text) });
}
function Kt(e) {
  w2.setData({ yAxisTopText: j(e.text) });
}
function Zt(e) {
  w2.setData({ yAxisBottomText: j(e.text) });
}
function Jt(e, a, h) {
  w2.addPoints([{ x: a, y: h, text: j(e.text) }]);
}
function $t(e) {
  w2.setConfig({ chartWidth: e });
}
function te(e) {
  w2.setConfig({ chartHeight: e });
}
function ee() {
  const e = Ft(), { themeVariables: a, quadrantChart: h } = e;
  return h && w2.setConfig(h), w2.setThemeConfig({
  ...
  }), w2.setData({ titleText: $l() }), w2.build();
}
var ie = function(e, a, h) {
  ge.parseDirective(this, e, a, h);
};
var ae = function() {
  w2.clear(), Fl();
};
...
var re = (e, a, h, f) => {
  ...
  const p = Ft();
  w.debug(`Rendering quadrant chart
` + e);
  const s = p.securityLevel;
  let o;
  s === "sandbox" && (o = Ct("#i" + a));
  const B = (s === "sandbox" ? Ct(o.nodes()[0].contentDocument.body) : Ct("body")).select(`[id="${a}"]`), V = B.append("g").attr("class", "main"), _ = ((U = p.quadrantChart) == null ? void 0 : U.chartWidth) || 500, D = ((q = p.quadrantChart) == null ? void 0 : q.chartHeight) || 500;
  Tl(B, D, _, ((T = p.quadrantChart) == null ? void 0 : T.useMaxWidth) || true), B.attr("viewBox", "0 0 " + _ + " " + D), f.db.setHeight(D), f.db.setWidth(_);
...
//# sourceMappingURL=quadrantDiagram-6f203608-OOHUIMTV.js.map
