...
// node_modules/mermaid/dist/journeyDiagram-f3c7ca51.js
var Z = function() {
  var t = function(_, n, a, h) {
    for (a = a || {}, h = _.length; h--; a[_[h]] = n)
      ;
    return a;
  }, e = [1, 2], s = [1, 5], r = [6, 9, 11, 17, 18, 20, 22, 23, 24, 26], i = [1, 15], l = [1, 16], c2 = [1, 17], y = [1, 18], u = [1, 19], x2 = [1, 20], g2 = [1, 24], f = [4, 6, 9, 11, 17, 18, 20, 22, 23, 24, 26], d2 = {
    trace: function() {
    },
    yy: {},
    ...
    table: [{ 3: 1, 4: e, 7: 3, 12: 4, 26: s }, { 1: [3] }, t(r, [2, 3], { 5: 6 }), { 3: 7, 4: e, 7: 3, 12: 4, 26: s }, { 13: 8, 27: [1, 9] }, { 27: [2, 18] }, { 6: [1, 10], 7: 21, 8: 11, 9: [1, 12], 10: 13, 11: [1, 14], 12: 4, 17: i, 18: l, 20: c2, 22: y, 23: u, 24: x2, 26: s }, { 1: [2, 2] }, { 14: 22, 15: [1, 23], 29: g2 }, t([15, 29], [2, 19]), t(r, [2, 8], { 1: [2, 1] }), t(r, [2, 4]), { 7: 21, 10: 25, 12: 4, 17: i, 18: l, 20: c2, 22: y, 23: u, 24: x2, 26: s }, t(r, [2, 6]), t(r, [2, 7]), t(r, [2, 11]), { 19: [1, 26] }, { 21: [1, 27] }, t(r, [2, 14]), t(r, [2, 15]), { 25: [1, 28] }, t(r, [2, 17]), { 11: [1, 29] }, { 16: 30, 28: [1, 31] }, { 11: [2, 21] }, t(r, [2, 5]), t(r, [2, 12]), t(r, [2, 13]), t(r, [2, 16]), t(f, [2, 9]), { 14: 32, 29: g2 }, { 29: [2, 20] }, { 11: [1, 33] }, t(f, [2, 10])],
        ...
        for (var m = this._currentRules(), o = 0; o < m.length; o++)
          if (h = this._input.match(this.rules[m[o]]), h && (!a || h[0].length > a[0].length)) {
            if (a = h, p = o, this.options.backtrack_lexer) {
              if (n = this.test_match(h, m[o]), n !== false)
                return n;
              if (this._backtrack) {
                a = false;
                continue;
...
var Pt = function(t, e, s) {
  ge.parseDirective(this, t, e, s);
};
var It = function() {
  J.length = 0, N.length = 0, L = "", j.length = 0, Fl();
};
var At = function(t) {
  L = t, J.push(t);
};
...
var zt = function(t, e) {
  ...
  function l(u) {
    const x2 = hn().startAngle(Math.PI / 2).endAngle(3 * (Math.PI / 2)).innerRadius(7.5).outerRadius(6.8181818181818175);
    u.append("path").attr("class", "mouth").attr("d", x2).attr("transform", "translate(" + e.cx + "," + (e.cy + 2) + ")");
  }
  function c2(u) {
    const x2 = hn().startAngle(3 * Math.PI / 2).endAngle(5 * (Math.PI / 2)).innerRadius(7.5).outerRadius(6.8181818181818175);
    u.append("path").attr("class", "mouth").attr("d", x2).attr("transform", "translate(" + e.cx + "," + (e.cy + 7) + ")");
  }
  function y(u) {
  ...
  return e.score > 3 ? l(i) : e.score < 3 ? c2(i) : y(i), r;
};
var lt = function(t, e) {
...
var Yt = function(t, e) {
  function s(i, l, c2, y, u) {
    return i + "," + l + " " + (i + c2) + "," + l + " " + (i + c2) + "," + (l + y - u) + " " + (i + c2 - u * 1.2) + "," + (l + y) + " " + i + "," + (l + y);
  }
...
var ut = function() {
  function t(i, l, c2, y, u, x2, g2, f) {
    const d2 = l.append("text").attr("x", c2 + u / 2).attr("y", y + x2 / 2 + 5).style("font-color", f).style("text-anchor", "middle").text(i);
    r(d2, g2);
  }
  function e(i, l, c2, y, u, x2, g2, f, d2) {
    const { taskFontSize: T, taskFontFamily: b } = f, _ = i.split(/<br\s*\/?>/gi);
    for (let n = 0; n < _.length; n++) {
      const a = n * T - T * (_.length - 1) / 2, h = l.append("text").attr("x", c2 + u / 2).attr("y", y).attr("fill", d2).style("text-anchor", "middle").style("font-size", T).style("font-family", b);
      h.append("tspan").attr("x", c2 + u / 2).attr("dy", a).text(_[n]), h.attr("y", y + x2 / 2).attr("dominant-baseline", "central").attr("alignment-baseline", "central"), r(h, g2);
    }
  }
  function s(i, l, c2, y, u, x2, g2, f) {
    const d2 = l.append("switch"), b = d2.append("foreignObject").attr("x", c2).attr("y", y).attr("width", u).attr("height", x2).attr("position", "fixed").append("xhtml:div").style("display", "table").style("height", "100%").style("width", "100%");
    b.append("div").attr("class", "label").style("display", "table-cell").style("text-align", "center").style("vertical-align", "middle").text(i), e(i, d2, c2, y, u, x2, g2, f), r(b, g2);
  }
  function r(i, l) {
    for (const c2 in l)
      c2 in l && i.attr(c2, l[c2]);
  }
  return function(i) {
...
function Gt(t) {
  ...
  Object.keys(P).forEach((r) => {
    ...
    B.drawText(t, c2), s += 20;
  });
}
var q = Ft().journey;
var C = q.leftMargin;
var Ht = function(t, e, s, r) {
  const i = Ft().journey, l = Ft().securityLevel;
  let c2;
  l === "sandbox" && (c2 = Ct("#i" + e));
  const y = l === "sandbox" ? Ct(c2.nodes()[0].contentDocument.body) : Ct("body");
  M.init();
  const u = y.select("#" + e);
  B.initGraphics(u);
  const x2 = r.db.getTasks(), g2 = r.db.getDiagramTitle(), f = r.db.getActors();
  for (const a in P)
    delete P[a];
  let d2 = 0;
  f.forEach((a) => {
  ...
  }), Gt(u), M.insert(0, 0, C, Object.keys(P).length * 50), Ut(u, x2, 0);
  const T = M.getBounds();
  g2 && u.append("text").text(g2).attr("x", C).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 25);
  const b = T.stopy - T.starty + 2 * i.diagramMarginY, _ = C + T.stopx + 2 * i.diagramMarginX;
  Tl(u, b, _, i.useMaxWidth), u.append("line").attr("x1", C).attr("y1", i.height * 4).attr("x2", _ - C - 4).attr("y2", i.height * 4).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)");
  const n = g2 ? 70 : 0;
...
var M = {
  ...
  updateBounds: function(t, e, s, r) {
    const i = Ft().journey, l = this;
    let c2 = 0;
    function y(u) {
      return function(g2) {
        c2++;
        const f = l.sequenceItems.length - c2 + 1;
        l.updateVal(g2, "starty", e - f * i.boxMargin, Math.min), l.updateVal(g2, "stopy", r + f * i.boxMargin, Math.max), l.updateVal(M.data, "startx", t - f * i.boxMargin, Math.min), l.updateVal(M.data, "stopx", s + f * i.boxMargin, Math.max), u !== "activation" && (l.updateVal(g2, "startx", t - f * i.boxMargin, Math.min), l.updateVal(g2, "stopx", s + f * i.boxMargin, Math.max), l.updateVal(M.data, "starty", e - f * i.boxMargin, Math.min), l.updateVal(M.data, "stopy", r + f * i.boxMargin, Math.max));
      };
    }
    this.sequenceItems.forEach(y());
  },
  insert: function(t, e, s, r) {
    const i = Math.min(t, s), l = Math.max(t, s), c2 = Math.min(e, r), y = Math.max(e, r);
    this.updateVal(M.data, "startx", i, Math.min), this.updateVal(M.data, "starty", c2, Math.min), this.updateVal(M.data, "stopx", l, Math.max), this.updateVal(M.data, "stopy", y, Math.max), this.updateBounds(i, c2, l, y);
  },
...
var Ut = function(t, e, s) {
  const r = Ft().journey;
  let i = "";
  const l = r.height * 2 + r.diagramMarginY, c2 = s + l;
  let y = 0, u = "#CCC", x2 = "black", g2 = 0;
  for (const [f, d2] of e.entries()) {
    if (i !== d2.section) {
      u = U[y % U.length], g2 = y % U.length, x2 = at[y % at.length];
      let b = 0;
      const _ = d2.section;
      ...
      B.drawSection(t, n, r), i = d2.section, y++;
    }
    const T = d2.people.reduce((b, _) => (P[_] && (b[_] = P[_]), b), {});
    d2.x = f * r.taskMargin + f * r.width + C, d2.y = c2, d2.width = r.diagramMarginX, d2.height = r.diagramMarginY, d2.colour = x2, d2.fill = u, d2.num = g2, d2.actors = T, B.drawTask(t, d2, r), M.insert(d2.x, d2.y, d2.x + d2.width + r.taskMargin, 300 + 5 * 30);
  }
};
var ct = {
  setConf: Xt,
...
//# sourceMappingURL=journeyDiagram-f3c7ca51-AXTY3NB2.js.map
