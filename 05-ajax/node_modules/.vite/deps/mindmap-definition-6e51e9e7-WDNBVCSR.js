...
// node_modules/mermaid/dist/mindmap-definition-6e51e9e7.js
var Ki = function() {
...
var Op = (pe, fe) => {
  switch (w.debug("In get type", pe, fe), pe) {
    case "[":
      return yt.RECT;
    case "(":
...
var Xu = { drawNode: Up, positionNode: Hp, drawEdge: Yp };
var qu = { exports: {} };
(function(pe, fe) {
  (function(ee, ce) {
    pe.exports = ce();
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    var Rr2 = il, Sa = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof ph < "u" ? ph : typeof self < "u" ? self : {};
    function sl(t, e) {
    ...
    function _l(t, e, r) {
      ...
      e = is(e) || 0, Rr2(r) && (f = !!r.leading, h = "maxWait" in r, i = h ? $l(is(r.maxWait) || 0, e) : i, c = "trailing" in r ? !!r.trailing : c);
      function v(A2) {
        var w2 = a, I = n;
        return a = n = void 0, u = A2, s = t.apply(I, w2), s;
      }
      function d(A2) {
        return u = A2, o = setTimeout(p, e), f ? v(A2) : s;
      }
      function g(A2) {
        var w2 = A2 - l, I = A2 - u, C = e - w2;
        return h ? Vl(C, i - I) : C;
      }
      function y(A2) {
        var w2 = A2 - l, I = A2 - u;
        return l === void 0 || w2 >= e || w2 < 0 || h && I >= i;
      }
      function p() {
        var A2 = ti2();
        if (y(A2))
      ...
      function E() {
        return o === void 0 ? s : m(ti2());
      }
      function M() {
        var A2 = ti2(), w2 = y(A2);
        if (a = arguments, n = this, l = A2, w2) {
          if (o === void 0)
            return d(l);
          if (h)
    ...
    var ln = _l, ri = D ? D.performance : null, ss = ri && ri.now ? function() {
      ...
      return r;
    }, fs = true, ql = console.warn != null, Wl = console.trace != null, ai = Number.MAX_SAFE_INTEGER || 9007199254740991, hs = function() {
      return true;
    }, cn = function() {
      return false;
    }, cs = function() {
    ...
    }(), ur = typeof Map < "u" ? Map : jl, ef = "undefined", tf = function() {
      function t(e) {
    ...
    var rf = sl(function(t, e) {
        ...
        n = Math.floor, h = Math.min, a = function(p, m) {
          ...
          for (m == null && (m = a), A2 = (function() {
            ...
            for (var C = 0, B = n(p.length / 2); 0 <= B ? C < B : C > B; 0 <= B ? C++ : C--)
              I.push(C);
            return I;
          }).apply(this).reverse(), w2 = [], E = 0, M = A2.length; E < M; E++)
            b = A2[E], w2.push(y(p, b, m));
          return w2;
        }, d = function(p, m, b) {
          var E;
          ...
          if (b == null && (b = a), M = p.slice(0, m), !M.length)
            return M;
          for (i(M, b), I = p.slice(m), A2 = 0, w2 = I.length; A2 < w2; A2++)
            E = I[A2], l(M, E, b);
          return M.sort(b).reverse();
        }, v = function(p, m, b) {
          var E, M, A2, w2, I, C, B, F2, R;
          if (b == null && (b = a), m * 10 <= p.length) {
            if (A2 = p.slice(0, m).sort(b), !A2.length)
              return A2;
            for (M = A2[A2.length - 1], B = p.slice(m), w2 = 0, C = B.length; w2 < C; w2++)
              E = B[w2], b(E, M) < 0 && (f(A2, E, 0, null, b), A2.pop(), M = A2[A2.length - 1]);
            return A2;
          }
          ...
          for (b == null && (b = a), M = p.length, I = m, A2 = p[m], E = 2 * m + 1; E < M; )
            w2 = E + 1, w2 < M && !(b(p[E], p[w2]) < 0) && (E = w2), p[m] = p[E], m = E, E = 2 * m + 1;
      ...
      dijkstra: function(e) {
        ...
        for (var M = function(W, Z) {
          ...
          var A2 = m.pop(), w2 = y(A2), I = A2.id();
          if (c[I] = w2, w2 !== 1 / 0)
            for (var C = A2.neighborhood().intersect(d), B = 0; B < C.length; B++) {
              var F2 = C[B], R = F2.id(), X = M(A2, F2), z = w2 + X.dist;
              z < y(F2) && (p(F2, z), h[R] = {
                node: A2,
                edge: X.edge
              });
      ...
      floydWarshall: function(e) {
        ...
        for (var m = new Array(h), b = new Array(h), E = 0; E < u.length; E++) {
          var M = u[E], A2 = M.source()[0], w2 = M.target()[0];
          if (A2 !== w2) {
            var I = c(A2), C = c(w2), B = I * f + C, F2 = s(M);
      ...
      bellmanFord: function(e) {
        var r = this, a = hf(e), n = a.weight, i = a.directed, s = a.root, o = n, l = this, u = this.cy(), f = this.byGroup(), h = f.edges, c = f.nodes, v = c.length, d = new ur(), g = false, y = [];
      ...
      kargerStein: function() {
        ...
        for (var c = 1 / 0, v = [], d = new Array(i), g = new Array(i), y = new Array(i), p = function(oe, de) {
          ...
          p(g, y);
          var A2 = si(g, E, l, 2), w2 = si(y, M, l, 2);
          A2.length <= w2.length && A2.length < c ? (c = A2.length, v = A2, p(g, d)) : w2.length <= A2.length && w2.length < c && (c = w2.length, v = w2, p(y, d));
        }
      ...
      {
        var E = a - u + l - o, M = n + f + o, A2 = a + u - l + o, w2 = M;
        if (h = Tr(e, r, a, n, E, M, A2, w2, false), h.length > 0)
          return h;
      }
      {
      ...
      for (var l = new Array(a.length), u = s / 2, f = o / 2, h = ci2(s, o), c = h * h, v = 0; v < a.length / 4; v++) {
        var d = void 0, g = void 0;
        v === 0 ? d = a.length - 2 : d = v * 4 - 2, g = v * 4 + 2;
        var y = n + u * a[v * 4], p = i + f * a[v * 4 + 1], m = -a[d] * a[g] - a[d + 1] * a[g + 1], b = h / Math.tan(Math.acos(m) / 2), E = y - b * a[d], M = p - b * a[d + 1], A2 = y + b * a[g], w2 = p + b * a[g + 1];
        l[v * 4] = E, l[v * 4 + 1] = M, l[v * 4 + 2] = A2, l[v * 4 + 3] = w2;
      ...
      if (m !== 0) {
        var b = y / m, E = p / m, M = 1e-3, A2 = 0 - M, w2 = 1 + M;
        return A2 <= b && b <= w2 && A2 <= E && E <= w2 ? [e + b * h, r + b * d] : u ? [e + b * h, r + b * d] : [];
      } else
      ...
      for (var u = [], f, h = new Array(a.length), c = s / 2, v = o / 2, d = ci2(s, o), g = 0; g < a.length / 4; g++) {
        var y = void 0, p = void 0;
        g === 0 ? y = a.length - 2 : y = g * 4 - 2, p = g * 4 + 2;
        var m = n + c * a[g * 4], b = i + v * a[g * 4 + 1], E = -a[y] * a[p] - a[y + 1] * a[p + 1], M = d / Math.tan(Math.acos(E) / 2), A2 = m - M * a[y], w2 = b - M * a[y + 1], I = m + M * a[p], C = b + M * a[p + 1];
        g === 0 ? (h[a.length - 2] = A2, h[a.length - 1] = w2) : (h[g * 4 - 2] = A2, h[g * 4 - 1] = w2), h[g * 4] = I, h[g * 4 + 1] = C;
        var B = a[y + 1], F2 = -a[y], R = B * a[p] + F2 * a[p + 1];
        R < 0 && (B *= -1, F2 *= -1);
        var X = A2 + B * d, z = w2 + F2 * d;
      ...
      pageRank: function(e) {
        ...
        for (var E = 0; E < v; E++) {
          var M = f[E], A2 = M.data("source"), w2 = M.data("target");
          if (A2 !== w2) {
            var I = u.indexOfId(A2), C = u.indexOfId(w2), B = s(M), F2 = C * h + I;
            d[F2] += B, g[I] += B;
          }
        }
    ...
    var Vf = Lt({
      ...
      betweennessCentrality: function(e) {
        ...
        for (var g = function(b) {
          for (var E = o[b].id(), M = [], A2 = {}, w2 = {}, I = {}, C = new Ra(function(Ee, ye) {
            return I[Ee] - I[ye];
          }), B = 0; B < o.length; B++) {
            var F2 = o[B].id();
            A2[F2] = [], w2[F2] = 0, I[F2] = 1 / 0;
          }
          for (w2[E] = 1, I[E] = 0, C.push(E); !C.empty(); ) {
            ...
            if (M.push(R), i)
              for (var X = 0; X < l[R].length; X++) {
                ...
                var Z = n(W);
                z = z.id(), I[z] > I[R] + Z && (I[z] = I[R] + Z, C.nodes.indexOf(z) < 0 ? C.push(z) : C.updateItem(z), w2[z] = 0, A2[z] = []), I[z] == I[R] + Z && (w2[z] = w2[z] + w2[R], A2[z].push(R));
              }
            else
              for (var ie = 0; ie < l[R].length; ie++) {
                var oe = l[R][ie].id();
                I[oe] == 1 / 0 && (C.push(oe), I[oe] = I[R] + 1), I[oe] == I[R] + 1 && (w2[oe] = w2[oe] + w2[R], A2[oe].push(R));
              }
          }
          for (var de = {}, se = 0; se < o.length; se++)
            de[o[se].id()] = 0;
          for (; M.length > 0; ) {
            for (var ve = M.pop(), we = 0; we < A2[ve].length; we++) {
              var Te = A2[ve][we];
              de[Te] = de[Te] + w2[Te] / w2[ve] * (1 + de[ve]);
            }
    ...
    var _f = Lt({
      ...
      for (var m = true, b = 0; m && b < i.maxIterations; )
        m = false, h = qf(f, l, i.expandFactor), f = Wf(h, l, i.inflateFactor), Kf(f, h, u, 4) || (m = true), b++;
      var E = Zf(f, l, r, n);
      return E = Jf(E), E;
    }, jf = {
      markovClustering: Os,
    ...
    var ah = Lt({
        ...
        for (var c = 0; c < i.k; c++) {
          ...
          if (v.length !== 0) {
            for (var d = i.attributes.length, g = l[c], y = new Array(d), p = new Array(d), m = 0; m < d; m++) {
              ...
              y[m] = p[m] / v.length, nh(y[m], g[m], i.sensitivityThreshold) || (u = true);
            }
        ...
        for (var d = 0; d < o.length; d++) {
          ...
          if (g.length !== 0) {
            ...
            for (var y = 0; y < g.length; y++)
              u = Bs(g[y], g, i.attributes), u < f[d] && (f[d] = u, o[d] = g[y], h = true);
            s[d] = r.collection(g);
          }
        }
        c++;
      ...
      for (var m = true, b = 0; m && b < n.maxIterations; )
        m = false, lh(s, a, o, u, n), fh(o, l, s, a, n), ih(o, l, n.sensitivityThreshold) || (m = true), b++;
      return i = hh(a, o, n, r), {
        clusters: i,
      ...
      for (var r = this.cy(), a = this.nodes(), n = gh2(e), i = n.attributes, s = function(b, E) {
      ...
      for (var y = zs(o, f, l, u, n); y; )
        y = zs(o, f, l, u, n);
      var p;
      return n.mode === "dendrogram" ? (p = yh(o[0], n.dendrogramDepth, r), n.addDendrogram && ph2(o[0], r)) : (p = new Array(o.length), o.forEach(function(m, b) {
      ...
      for (var w2 = new Array(o * n.minIterations), I = 0; I < w2.length; I++)
        w2[I] = 0;
      var C;
      for (C = 0; C < n.maxIterations; C++) {
        ...
        for (var se = 0, ve = 0; ve < o; ve++) {
          ...
          w2[C % n.minIterations * o + ve] = we, se += we;
        }
      ...
      hierholzer: function(e) {
        ...
        var a = Sh(e), n = a.root, i = a.directed, s = this, o = false, l, u, f;
        n && (f = j(n) ? this.filter(n)[0].id() : n[0].id());
        var h = {}, c = {};
        i ? s.forEach(function(m) {
          var b = m.id();
          if (m.isNode()) {
            var E = m.indegree(true), M = m.outdegree(true), A2 = E - M, w2 = M - E;
            A2 == 1 ? l ? o = true : l = b : w2 == 1 ? u ? o = true : u = b : (w2 > 1 || A2 > 1) && (o = true), h[b] = [], m.outgoers().forEach(function(I) {
        ...
        if (u && l)
          ...
          f || (f = s[0].id());
        var d = function(b) {
          for (var E = b, M = [b], A2, w2, I; h[E].length; )
            A2 = h[E].shift(), w2 = c[A2][0], I = c[A2][1], E != I ? (h[I] = h[I].filter(function(C) {
              return C != A2;
            }), E = I) : !i && E != w2 && (h[w2] = h[w2].filter(function(C) {
              return C != A2;
            }), E = w2), M.unshift(A2), M.unshift(E);
          return M;
        }, g = [], y = [];
    ...
    Ue(zr, {
      ...
      hook: function() {
        ...
        if (!e.hooked) {
          ...
          e.queue ? r = a.queue : r = a.current, r.push(this), ge(e.target) && e.target.cy().addToAnimationPool(e.target), e.hooked = true;
        }
        return this;
      },
      play: function() {
    ...
    function Ph(t, e) {
      if (Tn(t))
        return false;
      var r = typeof t;
      return r == "number" || r == "symbol" || r == "boolean" || t == null || Aa(t) ? true : kh.test(t) || !Rh.test(t) || e != null && t in Object(e);
    }
    ...
    function Mc(t) {
      ...
      if (r < 0)
        return false;
      var a = e.length - 1;
      return r == a ? e.pop() : Nc.call(e, r, 1), --this.size, true;
    }
    var Ic = Mc;
    function Rc(t) {
      var e = this.__data__, r = Cn(e, t);
    ...
    function Mv(t, e, r, a) {
      ...
      for (var n = -1, i = e.length, s = i - 1, o = t; o != null && ++n < i; ) {
        ...
        if (n != s) {
          var f = o[l];
          u = a ? a(f, l, o) : void 0, u === void 0 && (u = Rr2(f) ? f : Nv(e[n + 1]) ? [] : {});
        }
        Sv(o, l, u), o = o[l];
      }
      return t;
      ...
      for (var e = function(f) {
        ...
        switch (c) {
          ...
          case Be.COMPOUND_SPLIT: {
            var A2 = i(f.left, h), w2 = i(f.subject, h), I = i(f.right, h);
            return A2 + (A2.length > 0 ? " " : "") + w2 + I;
          }
          case Be.TRUE:
            return "";
        }
    ...
    ca = Ar = {}, Ar.renderedBoundingBox = function(t) {
      ...
      function r(s) {
        ...
        var b = v(f.width.val - h.w, g, y), E = b.biasDiff, M = b.biasComplementDiff, A2 = v(f.height.val - h.h, p, m), w2 = A2.biasDiff, I = A2.biasComplementDiff;
        o.autoPadding = d(h.w, h.h, s.pstyle("padding"), s.pstyle("padding-relative-to").value), o.autoWidth = Math.max(h.w, f.width.val), c.x = (-E + h.x1 + h.x2 + M) / 2, o.autoHeight = Math.max(h.h, f.height.val), c.y = (-w2 + h.y1 + h.y2 + I) / 2;
      }
      for (var a = 0; a < this.length; a++) {
    ...
    var Zt = function(e) {
      ...
      if (!r.cy().headless()) {
        ...
        if (o) {
          var l = r.pstyle("text-halign"), u = r.pstyle("text-valign"), f = Va(s, "labelWidth", a), h = Va(s, "labelHeight", a), c = Va(s, "labelX", a), v = Va(s, "labelY", a), d = r.pstyle(n + "text-margin-x").pfValue, g = r.pstyle(n + "text-margin-y").pfValue, y = r.isEdge(), p = r.pstyle(n + "text-rotation"), m = r.pstyle("text-outline-width").pfValue, b = r.pstyle("text-border-width").pfValue, E = b / 2, M = r.pstyle("text-background-padding").pfValue, A2 = 2, w2 = h, I = f, C = I / 2, B = w2 / 2, F2, R, X, z;
          if (y)
          ...
          if (ie || oe) {
            var de = ie ? Va(i.rstyle, "labelAngle", a) : p.pfValue, se = Math.cos(de), ve = Math.sin(de), we = (F2 + R) / 2, Te = (X + z) / 2;
            if (!y) {
              switch (l.value) {
                case "left":
                  we = R;
      ...
      if (b) {
        ...
        var A2 = 0, w2 = 0;
        n && r.includeUnderlays && (A2 = e.pstyle("underlay-opacity").value, A2 !== 0 && (w2 = e.pstyle("underlay-padding").value));
    ...
    var Dd = Lt({
      ...
      layoutPositions: function(e, r, a) {
        ...
        var u = function(A2, w2, I) {
          ...
          if (!f)
            return null;
          for (var A2 = Ut(), w2 = 0; w2 < n.length; w2++) {
            var I = n[w2], C = l(I, w2);
            Lf(A2, C.x, C.y);
          }
          return A2;
    ...
    function Md(t, e, r, a) {
      ...
      var I = function(F2) {
        return A2 || w2(), t === e && r === a ? F2 : F2 === 0 ? 0 : F2 === 1 ? 1 : y(M(F2), e, a);
      };
    ...
    function Rd(t, e, r, a) {
      ...
      if (s.duration === 0 ? y = 1 : y = (r - l) / s.duration, s.applying && (y = s.progress), y < 0 ? y = 0 : y > 1 && (y = 1), s.delay == null) {
        ...
        var E = s.startPan, M = s.pan, A2 = i.pan, w2 = M != null && a;
        w2 && (Xa(E.x, M.x) && (A2.x = ga(E.x, M.x, y, g)), Xa(E.y, M.y) && (A2.y = ga(E.y, M.y, y, g)), t.emit("pan"));
    ...
    function _o(t, e) {
      ...
      function n(f, h) {
        ...
        for (var p = function(A2) {
          for (var w2 = A2.length - 1; w2 >= 0; w2--) {
            var I = A2[w2];
            I();
          }
          ...
          !E.playing && !E.applying || (E.playing && E.applying && (E.applying = false), E.started || kd(f, b, t), Rd(f, b, t, h), E.applying && (E.applying = false), p(E.frames), E.step != null && E.step(t), b.completed() && (v.splice(m, 1), E.hooked = false, E.playing = false, E.started = false, p(E.completes)), g = true);
        }
    ...
    Bt.apply = function(t) {
      ...
      for (var h = function(Oe, Ie) {
        ...
        var m = a[p], b = l[m];
        if (b != null) {
          var E = this.properties[m], M = E.type, A2 = E.groupKey, w2 = void 0;
          E.hashOverride != null ? w2 = E.hashOverride(t, b) : b.pfValue != null && (w2 = b.pfValue);
          var I = E.enums == null ? b.value : null, C = w2 != null, B = I != null, F2 = C || B, R = b.units;
      ...
      switch (a.mapped) {
        case s.mapData: {
          ...
          if (E < 0 ? E = 0 : E > 1 && (E = 1), o.color) {
            var A2 = a.valueMin[0], w2 = a.valueMax[0], I = a.valueMin[1], C = a.valueMax[1], B = a.valueMin[2], F2 = a.valueMax[2], R = a.valueMin[3] == null ? 1 : a.valueMin[3], X = a.valueMax[3] == null ? 1 : a.valueMax[3], z = [Math.round(A2 + (w2 - A2) * E), Math.round(I + (C - I) * E), Math.round(B + (F2 - B) * E), Math.round(R + (X - R) * E)];
            i = {
    ...
    Wa.applyBypass = function(t, e, r, a) {
      ...
      for (var m = false, b = 0; b < t.length; b++) {
        for (var E = t[b], M = {}, A2 = void 0, w2 = 0; w2 < i.length; w2++) {
          var I = i[w2];
          if (a) {
    ...
    (function() {
      ...
      var W = Nt.properties = [].concat(g, b, y, p, m, B, d, v, f, h, c, M, A2, w2, R, I, C, z, F2), Z = Nt.propertyGroups = {
        // common to all eles
        behavior: g,
        transition: b,
        visibility: y,
    ...
    Vn.parse = function(t, e, r, a) {
      ...
      var i = a === "mapping" || a === true || a === false || a == null ? "dontcare" : a, s = r ? "t" : "f", o = "" + e, l = ls(t, o, s, i), u = n.propCache = n.propCache || [], f;
      ...
      if (u.multiple && a !== "multiple") {
        ...
        if (l ? b = e.split(/\s+/) : te(e) ? b = e : b = [e], u.evenMultiple && b.length % 2 !== 0)
          return null;
        for (var E = [], M = [], A2 = [], w2 = "", I = false, C = 0; C < b.length; C++) {
          var B = n.parse(t, b[C], r, "multiple");
          I = I || j(B.value), E.push(B.value), A2.push(B.pfValue != null ? B.pfValue : B.value), M.push(B.units), w2 += (C > 0 ? " " : "") + B.strValue;
        }
    ...
    }, Ft2.fromJson = function(t, e) {
      var r = new Ft2(t);
      return r.fromJson(e), r;
    }, Ft2.fromString = function(t, e) {
      return new Ft2(t).fromString(e);
    }, [Bt, Wa, Ii, lr, $n, Ri, Nt, Vn].forEach(function(t) {
      Ue(zt, t);
    }), Ft2.types = zt.types, Ft2.properties = zt.properties, Ft2.propertyGroups = zt.propertyGroups, Ft2.propertyGroupNames = zt.propertyGroupNames, Ft2.propertyGroupKeys = zt.propertyGroupKeys;
    var $d = {
      style: function(e) {
        if (e) {
      ...
      setStyle: function(e) {
        var r = this._private;
        return tt(e) ? r.style = e.generateStyle(this) : te(e) ? r.style = Ft2.fromJson(this, e) : j(e) ? r.style = Ft2.fromString(this, e) : r.style = Ft2(this), r.style;
      },
    ...
    Ue(_n, {
      ...
      mount: function(e) {
        if (e != null) {
          ...
          return !he(e) && he(e[0]) && (e = e[0]), r.stopAnimationLoop(), r.destroyRenderer(), a.container = e, a.styleEnabled = true, r.invalidateSize(), r.initRenderer(Ue({}, n, n.renderer, {
        ...
        if (L(e)) {
          if (r.startBatch(), e.elements) {
            var s = {}, o = function(E, M) {
              for (var A2 = [], w2 = [], I = 0; I < E.length; I++) {
                var C = E[I];
                if (!C.data.id) {
    ...
    Xo.prototype.run = function() {
      ...
      var E = function(A2, w2) {
        var I = e.startAngle + w2 * u * (n ? 1 : -1), C = f * Math.cos(I), B = f * Math.sin(I), F2 = {
          x: o.x + C,
          y: o.y + B
        };
        return F2;
    ...
    qo.prototype.run = function() {
      ...
      if (!e.avoidOverlap) {
        var w2 = p.length > 0 && p[0].length > 1, I = Math.min(s.w, s.h) / 2 - A2, C = I / (p.length + w2 ? 1 : 0);
        A2 = Math.min(A2, C);
      }
    ...
    Un.prototype.run = function() {
      ...
      r.stopped = false, (t.animate === true || t.animate === false) && r.emit({
        type: "layoutstart",
        layout: r
      }), t.debug === true ? ki = true : ki = false;
      var a = Xd(e, r, t);
      ki && Kd(a), t.randomize && Zd(a);
      var n = dr(), i = function() {
        Qd(a, e, t), t.fit === true && e.fit(t.padding);
      }, s = function(c) {
    ...
    var Xd = function(e, r, a) {
      ...
      for (s.graphSet.push(b); p <= m; ) {
        var M = y[p++], A2 = s.idToIndex[M], c = s.layoutNodes[A2], w2 = c.children;
        if (w2.length > 0) {
          s.graphSet.push(w2);
      ...
      for (var u = 0; u < s.edgeSize; u++) {
        ...
        if (W != Z) {
          for (var ie = qd(F2.sourceId, F2.targetId, s), oe = s.graphSet[ie], de = 0, g = s.layoutNodes[z]; oe.indexOf(g.id) === -1; )
    ...
    Vr.projectIntoViewport = function(t, e) {
      ...
      function y(w2, I) {
        ...
        if (w2.isEdge() && (I == null || I < v))
          if (d) {
            ...
            o.push(w2), d = w2, v = I ?? v;
      }
      function p(w2) {
        var I = w2.outerWidth() + 2 * h, C = w2.outerHeight() + 2 * h, B = I / 2, F2 = C / 2, R = w2.position();
      ...
      function m(w2) {
        var I = w2._private, C = I.rscratch, B = w2.pstyle("width").pfValue, F2 = w2.pstyle("arrow-scale").value, R = B / 2 + f, X = R * R, z = R * 2, ie = I.source, oe = I.target, re;
        ...
        for (var ie = ie || I.source, oe = oe || I.target, de = n.getArrowWidth(B, F2), se = [{
          name: "source",
          x: C.arrowStartX,
          y: C.arrowStartY,
          ...
          var ve = se[Z], we = i.arrowShapes[w2.pstyle(ve.name + "-arrow-shape").value], Te = w2.pstyle("width").pfValue;
      ...
      function E(w2, I) {
        var C = w2._private, B = c, F2;
        I ? F2 = I + "-" : F2 = "", w2.boundingBox();
        var R = C.labelBounds[I || "main"], X = w2.pstyle(F2 + "label").value, z = w2.pstyle("text-events").strValue === "yes";
        if (!(!z || !X)) {
          var re = b(C.rscratch, "labelX", I), W = b(C.rscratch, "labelY", I), Z = b(C.rscratch, "labelAngle", I), ie = w2.pstyle(F2 + "text-margin-x").pfValue, oe = w2.pstyle(F2 + "text-margin-y").pfValue, de = R.x1 - B - ie, se = R.x2 + B - ie, ve = R.y1 - B - oe, we = R.y2 + B - oe;
          if (Z) {
    ...
    Hn.calculateArrowAngles = function(t) {
      ...
      if (r && (p = (f + c) / 2, m = (h + v) / 2), l = c - f, u = v - h, i) {
        ...
        var d = e.allpts, A2 = e.ctrlpts, w2, I, C, B;
        if (A2.length / 2 % 2 === 0) {
          var F2 = d.length / 2 - 1, R = F2 + 2, X = R + 2;
          w2 = St(d[F2], d[R], d[X], 0), I = St(d[F2 + 1], d[R + 1], d[X + 1], 0), C = St(d[F2], d[R], d[X], 1e-4), B = St(d[F2 + 1], d[R + 1], d[X + 1], 1e-4);
        } else {
          var R = d.length / 2 - 1, F2 = R - 2, X = R + 2;
          w2 = St(d[F2], d[R], d[X], 0.4999), I = St(d[F2 + 1], d[R + 1], d[X + 1], 0.4999), C = St(d[F2], d[R], d[X], 0.5), B = St(d[F2 + 1], d[R + 1], d[X + 1], 0.5);
        }
        l = C - w2, u = B - I;
      }
    ...
    Vt.findHaystackPoints = function(t) {
      ...
      for (var p = 0; p < v; p++) {
        ...
        var M = b !== void 0 ? b : m, A2 = 1 - g, w2 = g, I = u === "node-position" ? o : l, C = {
          x: I.x1 * A2 + I.x2 * w2,
          y: I.y1 * A2 + I.y2 * w2
        };
      ...
      var W = p === a, Z = W ? z : X, ie = W ? F2 : B, oe = ms(ie), de = false;
      !(re && (E || A2)) && (m === o && ie < 0 || m === l && ie > 0 || m === i && ie > 0 || m === s && ie < 0) && (oe *= -1, Z = oe * Math.abs(Z), de = true);
      var se;
      if (E) {
        var ve = M < 0 ? 1 + M : M;
        se = ve * Z;
      ...
      if (!(!t || t.length === 0)) {
        ...
        for (var E = function(w2) {
          ...
          if (!C.hasUnbundled) {
            ...
            ii(C.eles), F2.forEach(function(Se) {
    ...
    Qa.manualEndptToPx = function(t, e) {
      ...
      if (c.endX = Re[0], c.endY = Re[1], c.arrowEndX = qe[0], c.arrowEndY = qe[1], w2 === "inside-to-node")
        ...
        r = c.srcIntn;
      else if (w2 === "outside-to-node" || w2 === "outside-to-node-or-label" ? X = F2 : (w2 === "outside-to-line" || w2 === "outside-to-line-or-label") && (X = [s.x, s.y]), r = e.nodeShapes[this.getNodeShape(a)].intersectLine(i.x, i.y, a.outerWidth(), a.outerHeight(), X[0], X[1], 0), w2 === "outside-to-node-or-label" || w2 === "outside-to-line-or-label") {
              ...
              case "multibezier": {
                for (var g = l(), y, p = 0, m = 0, b = 0; b < g.length; b++) {
                  for (var E = g[v ? b : g.length - 1 - b], M = 0; M < E.segments.length; M++) {
                    var A2 = E.segments[v ? M : E.segments.length - 1 - M], w2 = b === g.length - 1 && M === E.segments.length - 1;
                    if (p = m, m += A2.length, m >= d || w2) {
                      y = {
                        cp: E,
                        segment: A2
                      };
...
`), h = t.pstyle("text-max-width").pfValue, c = t.pstyle("text-overflow-wrap").value, v = c === "anywhere", d = [], g = /[\s\u200b]+/, y = v ? "" : " ", p = 0; p < f.length; p++) {
          ...
          if (E > h) {
            for (var A2 = m.split(g), w2 = "", I = 0; I < A2.length; I++) {
              var C = A2[I], B = w2.length === 0 ? C : w2 + y + C, F2 = this.calculateLabelDimensions(t, B), R = F2.width;
...
`), p = 0; p < y.length; p++) {
    ...
    var su = {}, ou = 28, uu = false;
    su.getNodeShape = function(t) {
      var e = this, r = t.pstyle("shape").value;
      if (r === "cutrectangle" && (t.width() < ou || t.height() < ou))
        return uu || (ft("The `cutrectangle` node shape can not be used at small sizes so `rectangle` is used instead"), uu = true), "rectangle";
      if (t.isParent())
            ...
            if (Ze && Ze.pannable() && Ze.active() && Ze.unactivate(), (!Ze || !Ze.grabbed()) && Qe != ut && (ut && r(ut, ["mouseout", "tapdragout"], N, {
              ...
              if (It) {
                if (me.boxSelectionEnabled() && br)
                  ...
                  Ht && t.redrawHint("eles", true), t.dragData.didDrag = true, t.hoverData.draggingEles || v(Ct2, {
                    inDragLayer: true
                  });
                  var Gt = {
                    x: 0,
        ...
        if (!(!le && !I(N))) {
          ...
          if (le && t.touchData.cxt) {
            ...
            if (Ee) {
              ...
              }), me.emit("pinchzoom"), Z = Pu, X = nr, z = Rt, re = Qt, W = _t, t.pinching = true;
            }
            if (N.touches[0]) {
              var ze = t.projectIntoViewport(N.touches[0].clientX, N.touches[0].clientY);
              be[0] = ze[0], be[1] = ze[1];
      ...
      return this.nodeShapes.barrel = {
        ...
        checkPoint: function(e, r, a, n, i, s, o) {
          ...
          if (gr(e, r, this.points, s, o, n, i - 2 * u, [0, -1], a) || gr(e, r, this.points, s, o, n - 2 * f, i, [0, -1], a))
            return true;
          for (var h = this.generateBarrelBezierPts(n, i, s, o), c = function(w2, I, C) {
            var B = C[4], F2 = C[2], R = C[0], X = C[5], z = C[1], re = Math.min(B, R), W = Math.max(B, R), Z = Math.min(X, z), ie = Math.max(X, z);
            if (re <= w2 && w2 <= W && Z <= I && I <= ie) {
              var oe = zf(B, F2, R), de = Mf(oe[0], oe[1], oe[2], w2), se = de.filter(function(ve) {
                return 0 <= ve && ve <= 1;
              });
              if (se.length > 0)
                return se[0];
    ...
    Dt.reasons = ba, Dt.getTextureQueue = function(t) {
      ...
      }, b = n && n === ba.dequeue, E = n && n === ba.highQuality, M = n && n === ba.downscale, A2, w2 = a + 1; w2 <= Gi; w2++) {
        var I = l.get(t, w2);
        if (I) {
          A2 = I;
          break;
      ...
      for (var r = this, a = r.getTextureQueue(t), n = r.getRetiredTextureQueue(t), i = 0; i < n.length; i++) {
        var s = n[i];
        if (s.width >= e)
          return s.retired = false, s.usedWidth = 0, s.invalidatedWidth = 0, s.fullnessChecks = 0, ii(s.eleCaches), s.context.setTransform(1, 0, 0, 1, 0, 0), s.context.clearRect(0, 0, s.width, s.height), wr(n, s), a.push(s), s;
      }
    ...
    var Ig = 1, en = -4, Zn = 2, Rg = 3.99, kg = 50, Pg = 50, Bg = 0.15, Fg = 0.1, zg = 0.9, Gg = 0.9, $g = 1, gu = 250, Vg = 4e3 * 4e3, _g = true, pu = function(e) {
      var r = this, a = r.renderer = e, n = a.cy;
      r.layersByLevel = {}, r.firstGet = true, r.lastInvalidationTime = dr() - 2 * gu, r.skipping = false, r.eleTxrDeqs = n.collection(), r.scheduleElementRefinement = ln(function() {
        r.refineElementTextures(r.eleTxrDeqs), r.eleTxrDeqs.unmerge(r.eleTxrDeqs);
      }, Pg), a.beforeRender(function(s, o) {
        o - r.lastInvalidationTime <= gu ? r.skipping = true : r.skipping = false;
    ...
    Mt.makeLayer = function(t, e) {
      ...
      for (var p = null, m = t.length / Ig, b = !o, E = 0; E < t.length; E++) {
        var M = t[E], A2 = M._private.rscratch, w2 = A2.imgLayerCaches = A2.imgLayerCaches || {}, I = w2[r];
        if (I) {
          p = I;
          continue;
        }
        if ((!p || p.eles.length >= m || !Es(p.bb, M.boundingBox())) && (p = y({
          ...
          return null;
        v || b ? a.queueLayer(p, M) : a.drawEleInLayer(p, M, r, e), p.eles.push(M), w2[r] = p;
      }
      return v || (b ? null : f);
      ...
      o.w === 0 || o.h === 0 || !e.visible() || (r = n.getEleLevelForLayerLevel(r, a), i.setImgSmoothing(s, false), i.drawCachedElement(s, e, null, null, r, _g), i.setImgSmoothing(s, true));
    ...
    Vi.safeDrawImage = function(t, e, r, a, n, i, s, o, l, u) {
      ...
      if (f(r, "background-width", "value", a) !== "auto" && (f(r, "background-width", "units", a) === "%" ? C = f(r, "background-width", "pfValue", a) * y : C = f(r, "background-width", "pfValue", a)), f(r, "background-height", "value", a) !== "auto" && (f(r, "background-height", "units", a) === "%" ? B = f(r, "background-height", "pfValue", a) * p : B = f(r, "background-height", "pfValue", a)), !(C === 0 || B === 0)) {
        ...
        if (A2 === "no" && we ? (i.setImgSmoothing(t, false), Te = true) : A2 === "yes" && !we && (i.setImgSmoothing(t, true), Te = true), c === "no-repeat")
          E && (t.save(), m.pathCache ? t.clip(m.pathCache) : (i.nodeShapes[i.getNodeShape(r)].draw(t, o, l, y, p), t.clip())), i.safeDrawImage(t, e, 0, 0, w2, I, R, Z, C, B), E && t.restore();
        else {
    ...
    _r.getTextAngle = function(t, e) {
      ...
      if (!(n && (o === 0 || e.pstyle("text-opacity").value === 0))) {
        ...
        if (c != null && c !== "" && !isNaN(l) && !isNaN(u)) {
          ...
          var A2 = e.pstyle("text-background-opacity").value, w2 = e.pstyle("text-border-opacity").value, I = e.pstyle("text-border-width").pfValue, C = e.pstyle("text-background-padding").pfValue;
          if (A2 > 0 || I > 0 && w2 > 0) {
            var B = l - C;
            switch (b) {
              case "left":
            ...
            if (I > 0 && w2 > 0) {
              ...
              if (t.strokeStyle = "rgba(" + oe[0] + "," + oe[1] + "," + oe[2] + "," + w2 * o + ")", t.lineWidth = I, t.setLineDash)
                switch (de) {
                  case "dotted":
                    t.setLineDash([1, 1]);
                    break;
              ...
              if (t.strokeRect(B, F2, R, X), de === "double") {
                var se = I / 2;
    ...
    Ea.drawNode = function(t, e, r) {
      ...
      if (!(!k(h.x) || !k(h.y)) && !(i && !e.visible())) {
        ...
        for (var m = e.pstyle("background-image"), b = m.value, E = new Array(b.length), M = new Array(b.length), A2 = 0, w2 = 0; w2 < b.length; w2++) {
          var I = b[w2], C = E[w2] = I != null && I !== "none";
          if (C) {
            var B = e.cy().style().getIndexedStyle(e, "background-image-crossorigin", "value", w2);
            A2++, M[w2] = s.getCachedImage(I, B, function() {
        ...
        if (v) {
          ...
          we != null ? (d = we, g = true, f.pathCache = d) : (d = new Path2D(), se[ve] = f.pathCache = d);
        }
        var Te = function() {
          if (!g) {
            var ke = h;
    ...
    Wt.getPixelRatio = function() {
      ...
      if (a === "radial-gradient")
        ...
        var b = s ? {
          x: 0,
          y: 0
        } : r.position(), E = r.paddedWidth(), M = r.paddedHeight(), A2 = E / 2, w2 = M / 2, I = r.pstyle("background-gradient-direction").value;
        switch (I) {
          case "to-bottom":
            i = t.createLinearGradient(b.x, b.y - w2, b.x, b.y + w2);
            break;
          case "to-top":
            i = t.createLinearGradient(b.x, b.y + w2, b.x, b.y - w2);
            break;
          ...
          case "to-right-bottom":
            i = t.createLinearGradient(b.x - A2, b.y - w2, b.x + A2, b.y + w2);
            break;
          case "to-top-right":
          case "to-right-top":
            i = t.createLinearGradient(b.x - A2, b.y + w2, b.x + A2, b.y - w2);
      ...
      if (h || (s.textureDrawLastFrame = false), h) {
        ...
        z.setTransform(1, 0, 0, 1, 0, 0), c ? F2(z, 0, 0, w2.width, w2.height) : z.clearRect(0, 0, w2.width, w2.height);
        ...
        var b = l.zoom();
        R(z, false), z.clearRect(w2.mpan.x, w2.mpan.y, w2.width / w2.zoom / o, w2.height / w2.zoom / o), z.drawImage(re, w2.mpan.x, w2.mpan.y, w2.width / w2.zoom / o, w2.height / w2.zoom / o);
      } else
      ...
      if (se[s.NODE] = !f[s.NODE] && c && !s.clearedForMotionBlur[s.NODE] || s.clearingMotionBlur, se[s.NODE] && (s.clearedForMotionBlur[s.NODE] = true), se[s.DRAG] = !f[s.DRAG] && c && !s.clearedForMotionBlur[s.DRAG] || s.clearingMotionBlur, se[s.DRAG] && (s.clearedForMotionBlur[s.DRAG] = true), f[s.NODE] || r || a || se[s.NODE]) {
        ...
        R(z, we), de ? s.drawCachedNodes(z, B.nondrag, o, ie) : s.drawLayeredElements(z, B.nondrag, o, ie), s.debug && s.drawDebugPoints(z, B.nondrag), !r && !c && (f[s.NODE] = false);
      }
      if (!a && (f[s.DRAG] || r || se[s.DRAG])) {
        var ve = c && !se[s.DRAG] && v !== 1, z = e || (ve ? s.data.bufferContexts[s.MOTIONBLUR_BUFFER_DRAG] : u.contexts[s.DRAG]);
        R(z, c && !ve ? "motionBlur" : void 0), de ? s.drawCachedNodes(z, B.drag, o, ie) : s.drawCachedElements(z, B.drag, o, ie), s.debug && s.drawDebugPoints(z, B.drag), !r && !c && (f[s.DRAG] = false);
      }
    ...
    Ur.instanceString = function() {
      ...
      if (j(t))
        ...
        for (var a = t, n = Object.keys(a), i = 0; i < n.length; i++) {
          var s = n[i], o = a[s];
          if (o != null) {
            var l = Ft2.properties[s] || Ft2.properties[pt(s)];
            if (l != null) {
              var u = l.name, f = o;
              this[r].properties.push({
                name: u,
        ...
        function(ee) {
            ...
            V.prototype.getNodes = function() {
              ...
              if (this.isConnected = false, ue.size >= this.nodes.length) {
                ...
                ue.forEach(function(ge) {
                  ge.owner == Q && he++;
                }), he == this.nodes.length && (this.isConnected = true);
              }
            }, ee.exports = V;
          },
          /* 6 */
          ...
          function(ee, ce, H) {
            ...
            T.calcSeparationAmount = function(x, S, G, U) {
              ...
              var V = x.getX(), _ = x.getY(), Q = x.getRight(), ne = x.getX(), ue = x.getBottom(), J = x.getRight(), j = x.getWidthHalf(), Y = x.getHeightHalf(), te = S.getX(), L = S.getY(), $ = S.getRight(), k = S.getX(), q = S.getBottom(), he = S.getRight(), ge = S.getWidthHalf(), Ae = S.getHeightHalf(), Ne = false, _e = false;
              if (U === K) {
                if (P > D)
                ...
                if (-tt === Pe ? U > K ? (G[0] = ne, G[1] = ue, Ne = true) : (G[0] = Q, G[1] = _, Ne = true) : tt === Pe && (U > K ? (G[0] = V, G[1] = _, Ne = true) : (G[0] = J, G[1] = ue, Ne = true)), -ct === Pe ? K > U ? (G[2] = k, G[3] = q, _e = true) : (G[2] = $, G[3] = L, _e = true) : ct === Pe && (K > U ? (G[2] = te, G[3] = L, _e = true) : (G[2] = he, G[3] = q, _e = true)), Ne && _e)
                  return false;
      ...
      return (
        ...
        function(ce) {
          ...
          function O(T) {
            ...
            return ce[T].call(x.exports, x, x.exports, O), x.l = true, x.exports;
          }
          ...
          function(ce, H, O) {
            ...
            for (var S in T)
              x[S] = T[S];
            x.DEFAULT_USE_MULTI_LEVEL_SCALING = false, x.DEFAULT_RADIAL_SEPARATION = T.DEFAULT_EDGE_LENGTH, x.DEFAULT_COMPONENT_SEPERATION = 60, x.TILE = true, x.TILING_PADDING_VERTICAL = 10, x.TILING_PADDING_HORIZONTAL = 10, x.TREE_REDUCTION_ON_INCREMENTAL = false, ce.exports = x;
          },
          /* 2 */
          /***/
          function(ce, H, O) {
            ...
            Y.prototype.newGraphManager = function() {
              ...
              for (var L = [], $ = true, k; $; ) {
                ...
                for (var ge = 0; ge < q.length; ge++)
                  k = q[ge], k.getEdges().length == 1 && !k.getEdges()[0].isInterGraph && k.getChild() == null && (he.push([k, k.getEdges()[0], k.getOwner()]), $ = true);
                if ($ == true) {
          ...
          _.prototype.run = function() {
            ...
            for (var Y = J.length, te = 0; te < Y; te++) {
              ...
              if (L.outerWidth() != null && L.outerHeight() != null ? k = ue.add(new U(j.graphManager, new P(L.position("x") - q.w / 2, L.position("y") - q.h / 2), new K(parseFloat(q.w), parseFloat(q.h)))) : k = ue.add(new U(this.graphManager)), k.id = L.data("id"), k.paddingLeft = parseInt(L.css("padding")), k.paddingTop = parseInt(L.css("padding")), k.paddingRight = parseInt(L.css("padding")), k.paddingBottom = parseInt(L.css("padding")), this.options.nodeDimensionsIncludeLabels && L.isParent()) {
                var he = L.boundingBox({ includeLabels: true, includeNodes: false }).w, ge = L.boundingBox({ includeLabels: true, includeNodes: false }).h, Ae = L.css("text-halign");
...
function Qp(pe, fe) {
  fe.edges().map((ee, ce) => {
    ...
    if (ee[0]._private.bodyBounds) {
      ...
      w.trace("Edge: ", ce, H), pe.insert("path").attr(
        "d",
...
function Jp(pe, fe) {
  return new Promise((ee) => {
    const ce = Ct("body").append("div").attr("id", "cy").attr("style", "display:none"), H = Wu({
...
function jp(pe) {
  pe.nodes().map((fe, ee) => {
    ...
    w.info("Id:", ee, "Position: (", fe.position().x, ", ", fe.position().y, ")", ce), H.attr(
      "transform",
      `translate(${fe.position().x - ce.width / 2}, ${fe.position().y - ce.height / 2})`
    ), H.attr("attr", `apa-${ee})`);
  });
}
var ey = async (pe, fe, ee, ce) => {
  const H = Ft();
  H.htmlLabels = false, w.debug(`Rendering mindmap diagram
` + pe, ce.parser);
  const O = Ft().securityLevel;
  let T;
  O === "sandbox" && (T = Ct("#i" + fe));
  ...
  Qp(U, K), jp(K), Cy(void 0, S, H.mindmap.padding, H.mindmap.useMaxWidth);
};
var ty = {
  draw: ey
};
var ry = (pe) => {
  ...
  for (let ee = 0; ee < pe.THEME_COLOR_LIMIT; ee++)
    pe["lineColor" + ee] = pe["lineColor" + ee] || pe["cScaleInv" + ee], ci(pe["lineColor" + ee]) ? pe["lineColor" + ee] = F(pe["lineColor" + ee], 20) : pe["lineColor" + ee] = A(pe["lineColor" + ee], 20);
  for (let ee = 0; ee < pe.THEME_COLOR_LIMIT; ee++) {
    const ce = "" + (17 - 3 * ee);
    fe += `
...
mermaid/dist/mindmap-definition-6e51e9e7.js:
  (*!
...
*/
//# sourceMappingURL=mindmap-definition-6e51e9e7-WDNBVCSR.js.map
