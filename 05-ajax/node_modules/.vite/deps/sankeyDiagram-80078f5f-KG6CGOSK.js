...
// node_modules/mermaid/dist/sankeyDiagram-80078f5f.js
function At(t) {
...
` + o + "^";
      ...
      next: function() {
        ...
        return o ? (s = this.test_match(o, b[m]), s !== false ? s : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
...
var It = (t) => (t = Rn.sanitizeText(t, Ft()), B[t] || (B[t] = new Ct2(t), Q.push(B[t])), B[t]);
var Ot = () => Q;
var $t = () => q;
var zt = () => ({
...
function Yt() {
  ...
  function E({ nodes: e, links: f }) {
    ...
    const l = new Map(e.map((h2, r) => [_(h2, r, e), h2]));
  ...
  function P({ nodes: e }) {
    ...
    for (const r of e) {
      ...
      r.layer = k, r.x0 = t + k * l, r.x1 = r.x0 + u, h2[k] ? h2[k].push(r) : h2[k] = [r];
    }
    if (o)
      for (const r of h2)
        r.sort(o);
  ...
  function z(e) {
    ...
    for (const l of e) {
      let h2 = n;
      for (const r of l) {
        r.y0 = h2, r.y1 = h2 + r.value * f, h2 = r.y1 + p;
        for (const k of r.sourceLinks)
          k.width = k.value * f;
      }
      h2 = (a - h2 + p) / (l.length + 1);
      for (let r = 0; r < l.length; ++r) {
        const k = l[r];
        k.y0 += h2 * (r + 1), k.y1 += h2 * (r + 1);
      }
      O(l);
    }
  }
  ...
  function C(e, f) {
    ...
    g(e, h2.y0 - p, l - 1, f), I(e, h2.y1 + p, l + 1, f), g(e, a, e.length - 1, f), I(e, n, 0, f);
  }
  function I(e, f, l, h2) {
    for (; l < e.length; ++l) {
      const r = e[l], k = (f - r.y0) * h2;
      k > 1e-6 && (r.y0 += k, r.y1 += k), f = r.y1 + p;
    }
  }
  function g(e, f, l, h2) {
    for (; l >= 0; --l) {
      const r = e[l], k = (r.y1 - f) * h2;
...
//# sourceMappingURL=sankeyDiagram-80078f5f-KG6CGOSK.js.map
