...
// node_modules/mermaid/dist/createText-98e4790d.js
function Tt(n, r) {
  ...
  function u(i) {
    if (i === 62) {
      ...
      return a.open || (n.enter("blockQuote", {
        _container: true
      }), a.open = true), n.enter("blockQuotePrefix"), n.enter("blockQuoteMarker"), n.consume(i), n.exit("blockQuoteMarker"), l;
    }
    return t(i);
  }
  function l(i) {
...
function vt(n, r, t) {
  const e = this, u = {
    ...
    tokenize: L,
    partial: true
  }, i = this.events[this.events.length - 1], a = i && i[1].type === "linePrefix" ? i[2].sliceSerialize(i[1], true).length : 0;
  let c = 0, p;
  return h;
  function h(d) {
...
function ee(n, r, t) {
  ...
  function l(i) {
    ...
    return a && a[1].type === "linePrefix" && a[2].sliceSerialize(a[1], true).length >= 4 ? r(i) : C(i) ? u(i) : t(i);
  }
}
var re = {
  name: "codeText",
...
function it(n) {
  ...
  for (; ++t < n.length; ) {
    ...
    if (e[0] === "enter")
      e[1].contentType && (Object.assign(r, ae(n, t)), t = r[t], p = true);
...
function ae(n, r) {
  ...
  for (; f; ) {
    for (; n[++u][1] !== f; )
      ;
    l.push(u), f._tokenizer || (h = e.sliceStream(f), f.next || h.push(null), x && i.defineSkip(f.start), f._isInFirstContentOfListItem && (i._gfmTasklistFirstContentOfListItem = true), i.write(h), f._isInFirstContentOfListItem && (i._gfmTasklistFirstContentOfListItem = void 0)), x = f, f = f.next;
  }
  for (f = t; ++g < a.length; )
...
function pe(n, r, t) {
  ...
  function l(i) {
    if (i === null || C(i))
      return t(i);
    const a = e.events[e.events.length - 1];
    return !e.parser.constructs.disable.null.includes("codeIndented") && a && a[1].type === "linePrefix" && a[2].sliceSerialize(a[1], true).length >= 4 ? r(i) : n.interrupt(e.parser.constructs.flow, t, r)(i);
  }
}
...
var Yn = ["pre", "script", "style", "textarea"];
var Ee = {
  name: "htmlFlow",
  tokenize: Ae,
  resolveTo: Ce,
...
function Ae(n, r, t) {
  ...
  function h(o) {
    return o === 33 ? (n.consume(o), x) : o === 47 ? (n.consume(o), k) : o === 63 ? (n.consume(o), u = 3, e.interrupt ? r : U) : tn(o) ? (n.consume(o), i = String.fromCharCode(o), l = true, B) : t(o);
  }
  function x(o) {
...
function Ze(n, r, t) {
  ...
  let l = u && u[1].type === "linePrefix" ? u[2].sliceSerialize(u[1], true).length : 0, i = 0;
  return a;
  function a(f) {
  ...
  function h(f) {
    return e.containerState.initialBlankLine = true, l++, g(f);
  }
  function x(f) {
    return q(f) ? (n.enter("listItemPrefixWhitespace"), n.consume(f), n.exit("listItemPrefixWhitespace"), g) : t(f);
  }
  function g(f) {
    return e.containerState.size = l + e.sliceSerialize(n.exit("listItemPrefix"), true).length, r(f);
  }
}
function Ye(n, r, t) {
  const e = this;
...
function Ge(n, r, t) {
  ...
  function u(l) {
    ...
    return i && i[1].type === "listItemIndent" && i[2].sliceSerialize(i[1], true).length === e.containerState.size ? r(l) : t(l);
  }
}
function Je(n) {
  ...
  function(n, r, t) {
    return typeof r != "string" && (t = r, r = void 0), Cr(t)(
      Sr(
        ...
        br(t).document().write(yr()(n, r, true))
      )
    );
  }
);
function Cr(n) {
  ...
  function e(m) {
    ...
    if (w2.tokenStack.length > 0) {
      const X = w2.tokenStack[w2.tokenStack.length - 1];
      (X[1] || vn).call(w2, void 0, X[0]);
    }
    for (b.position = {
      start: on(
  ...
  function u(m, b, w2) {
    let z = b - 1, I = -1, X = false, an, rn, gn, kn;
    for (; ++z <= w2; ) {
      const M = m[z];
      if (M[1].type === "listUnordered" || M[1].type === "listOrdered" || M[1].type === "blockQuote" ? (M[0] === "enter" ? I++ : I--, kn = void 0) : M[1].type === "lineEndingBlank" ? M[0] === "enter" && (an && !kn && !I && !gn && (gn = z), kn = void 0) : M[1].type === "linePrefix" || M[1].type === "listItemValue" || M[1].type === "listItemMarker" || M[1].type === "listItemPrefix" || M[1].type === "listItemPrefixWhitespace" || (kn = void 0), !I && M[0] === "enter" && M[1].type === "listItemPrefix" || I === -1 && M[0] === "exit" && (M[1].type === "listUnordered" || M[1].type === "listOrdered")) {
        if (an) {
          ...
          for (rn = void 0; En--; ) {
            ...
            if (un[1].type === "lineEnding" || un[1].type === "lineEndingBlank") {
              if (un[0] === "exit")
                continue;
              rn && (m[rn][1].type = "lineEndingBlank", X = true), un[1].type = "lineEnding", rn = En;
          ...
          gn && (!rn || gn < rn) && (an._spread = true), an.end = Object.assign(
            {},
            rn ? m[rn][1].start : M[1].end
          ), m.splice(rn || z, 0, ["exit", an, M[2]]), z++, w2++;
        }
        ...
        }, m.splice(z, 0, ["enter", an, M[2]]), z++, w2++, gn = void 0, kn = true);
      }
    }
    return m[b][1]._spread = X, w2;
  }
  function l(m, b) {
    t[m] = b;
  }
  ...
  function p(m, b, w2) {
    return this.stack[this.stack.length - 1].children.push(m), this.stack.push(m), this.tokenStack.push([b, w2]), m.position = {
      start: on(b.start)
    }, m;
  }
  function h(m) {
    return b;
    function b(w2) {
      m && m.call(this, w2), x.call(this, w2);
    }
  }
  function x(m, b) {
    const w2 = this.stack.pop(), z = this.tokenStack.pop();
    if (z)
    ...
    return w2.position.end = on(m.end), w2;
  }
  function g() {
  ...
  function y() {
    i("flowCodeInside") || (this.buffer(), l("flowCodeInside", true));
  }
  function _() {
    const m = this.resume(), b = this.stack[this.stack.length - 1];
  ...
  function L(m) {
    const b = this.resume(), w2 = this.stack[this.stack.length - 1];
    w2.label = b, w2.identifier = fn(
  ...
  function P(m) {
    ...
    if (!b.depth) {
      const w2 = this.sliceSerialize(m).length;
      b.depth = w2;
    }
  }
  function j() {
  ...
  function S(m) {
    const b = this.stack[this.stack.length - 1];
    let w2 = b.children[b.children.length - 1];
    (!w2 || w2.type !== "text") && (w2 = wt(), w2.position = {
      start: on(m.start)
    }, b.children.push(w2)), this.stack.push(w2);
  }
  function E(m) {
  ...
  function A(m) {
    const b = this.stack[this.stack.length - 1];
    if (i("atHardBreak")) {
      const w2 = b.children[b.children.length - 1];
      w2.position.end = on(m.end), l("atHardBreak");
      return;
    }
  ...
  function H(m) {
    const b = this.sliceSerialize(m), w2 = this.stack[this.stack.length - 2];
    w2.label = Er(b), w2.identifier = fn(b).toLowerCase();
  }
  function s() {
    const m = this.stack[this.stack.length - 1], b = this.resume(), w2 = this.stack[this.stack.length - 1];
    if (l("inReference", true), w2.type === "link") {
      const z = m.children;
      w2.children = z;
    } else
      w2.alt = b;
  ...
  function ln(m) {
    const b = this.sliceSerialize(m), w2 = i("characterReferenceType");
    let z;
    w2 ? (z = ct(
      b,
      w2 === "characterReferenceMarkerNumeric" ? 10 : 16
...
var Rr = (n, r = "", {
  ...
  if (w.info("createText", r, t, e, u, l, i, c), l) {
    const p = Tr(r), h = {
      isNode: i,
      label: Ab(p).replace(
        /fa[blrs]?:fa-[\w-]+/g,
...
//# sourceMappingURL=chunk-KQ24I337.js.map
