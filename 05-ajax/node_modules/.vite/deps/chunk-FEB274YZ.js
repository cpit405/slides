...
// node_modules/mermaid/dist/linear-50d4520f.js
function $(n, t2) {
...
function B(n, t2) {
  var e = typeof t2, r;
  return t2 == null || e === "boolean" ? Ln(t2) : (e === "number" ? Qt : e === "string" ? (r = Je(t2)) ? (t2 = r, Lo) : vu : t2 instanceof Je ? Lo : t2 instanceof Date ? xn : kn(t2) ? Nn : Array.isArray(t2) ? vn : typeof t2.valueOf != "function" && typeof t2.toString != "function" || isNaN(t2) ? An : Qt)(n, t2);
}
function Sn(n, t2) {
  ...
  function f(c) {
    ...
    function X(s) {
      ...
      if (d === "c")
        ...
        s = +s;
        var P = s < 0 || 1 / s < 0;
        if (s = isNaN(s) ? h : V(Math.abs(s), w), O && (s = Fn(s)), P && +s == 0 && M !== "+" && (P = false), N = (P ? M === "(" ? M : u : M === "-" || M === "(" ? "" : M) + N, g = (d === "s" ? W[8 + rn / 3] : "") + g + (P && M === "(" ? ")" : ""), fn) {
...
function Vn() {
  ...
  return c.invert = function(m) {
    return o(i((f || (f = u(t2, n.map(r), Qt)))(m)));
  }, c.domain = function(m) {
...
function Un(n, t2, e, r) {
  ...
  switch (r = E(r ?? ",f"), r.type) {
    ...
    case "f":
    case "%": {
      r.precision == null && !isNaN(a = Ln2(i)) && (r.precision = a - (r.type === "%") * 2);
      break;
    }
  }
  return en(r);
...
//# sourceMappingURL=chunk-FEB274YZ.js.map
