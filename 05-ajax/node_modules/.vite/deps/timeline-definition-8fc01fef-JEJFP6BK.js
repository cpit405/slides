...
// node_modules/mermaid/dist/timeline-definition-8fc01fef.js
var parser = function() {
...
var genSections = (options) => {
  ...
  for (let i = 0; i < options.THEME_COLOR_LIMIT; i++) {
    ...
    if (isDark$1(options["lineColor" + i])) {
      options["lineColor" + i] = lighten$1(options["lineColor" + i], 20);
    } else {
      options["lineColor" + i] = darken$1(options["lineColor" + i], 20);
    }
  }
  for (let i = 0; i < options.THEME_COLOR_LIMIT; i++) {
    const sw = "" + (17 - 3 * i);
...
//# sourceMappingURL=timeline-definition-8fc01fef-JEJFP6BK.js.map
